...
inline void GenCylinder(std::vector<glm::vec3>& triangle_points,std::vector<int>& indexs,float radius, float height, int x_dimesion,int y_dimesion)
{
	std::vector<glm::vec3> all_points;
	std::vector<int> all_indexs;
