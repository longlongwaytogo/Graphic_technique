// from : http://www.cnblogs.com/aokman/archive/2010/11/14/1876987.html
...
void SetupWindow(void)
{
	...
	drawContext = SDL_SetVideoMode(SCREEN_WIDTH, SCREEN_HEIGHT, 0, SDL_OPENGL);
...
int main(int argc, char* argv[])
{
	...
	// multiSample support
	GLint nMaxSample = 0;
	glGetIntegerv(GL_MAX_SAMPLES,&nMaxSample);
	std::cout<<"Max Sample support:" << nMaxSample << std::endl;
